	...
	public:
		...
		oneMessage(String^message, String^senderMail)
		{
			...
			if (FacebookSys::user_email == senderMail)
			{
				...
				pictureBox2->BackgroundImage = Image::FromFile(L"C:\\Users\\Eng Mahmoud\\Downloads\\free-vector-pill-button-blue-clip-art_116761_Pillbuttonblue_clip_art_hight.png");
			}
		}
	protected:
		/// <summary>

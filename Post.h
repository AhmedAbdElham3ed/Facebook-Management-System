...
namespace FacebookSystem {
	...
	public:
		...
		Dictionary<String^, String^>^reactionsImagesPath = gcnew Dictionary<String^, String^>();
		String^ hahaimage = L"C:\\Users\\Dell\\Desktop\\Facebook System\\Facbook Matrial\\Constant Reacts\\hahaC.PNG";
		String^ likeimage = L"C:\\Users\\Dell\\Desktop\\Facebook System\\Facbook Matrial\\Constant Reacts\\likeC.PNG";
		String^ loveimage = L"C:\\Users\\Dell\\Desktop\\Facebook System\\Facbook Matrial\\Constant Reacts\\loveC.PNG";
		String^ wowimage = L"C:\\Users\\Dell\\Desktop\\Facebook System\\Facbook Matrial\\Constant Reacts\\wowC.PNG";
		String^ sadimage = L"C:\\Users\\Dell\\Desktop\\Facebook System\\Facbook Matrial\\Constant Reacts\\sadC.PNG";
		String^ angryimage = L"C:\\Users\\Dell\\Desktop\\Facebook System\\Facbook Matrial\\Constant Reacts\\angryC.PNG";
		String^ noLike_Image = L"C:C:\\Users\\Dell\\Desktop\\Facebook System\\Facbook Matrial\\Constant Reacts\\Like-512.PNG";
			...
			if (totalReactors != 0)
			{
				...
				if (ReactedByMe)
				{
					...
					if (reactTypebyme == "like")
					{
						...
						bunifuFlatButton1->Iconimage = Image::FromFile(reactionsImagesPath["like"]);
					}
					if (reactTypebyme == "love")
					{
						bunifuFlatButton1->Text = "Love";
						bunifuFlatButton1->Textcolor = Color::FromArgb(243, 82, 105);
						bunifuFlatButton1->Iconimage = Image::FromFile(reactionsImagesPath["love"]);
					}
					if (reactTypebyme == "sad")
					{
						bunifuFlatButton1->Text = "Sad";
						bunifuFlatButton1->Textcolor = Color::FromArgb(240, 186, 21);
						bunifuFlatButton1->Iconimage = Image::FromFile(reactionsImagesPath["sad"]);
					...
					if (reactTypebyme == "angry")
					{
						...
						bunifuFlatButton1->Iconimage = Image::FromFile(reactionsImagesPath["angry"]);
					}
					if (reactTypebyme == "haha")
					{
						bunifuFlatButton1->Text = "Haha";
						bunifuFlatButton1->Textcolor = Color::FromArgb(240, 186, 21);
						bunifuFlatButton1->Iconimage = Image::FromFile(reactionsImagesPath["haha"]);
					}
					if (reactTypebyme == "wow")
					{
						bunifuFlatButton1->Text = "Wow";
						bunifuFlatButton1->Textcolor = Color::FromArgb(240, 186, 21);
						bunifuFlatButton1->Iconimage = Image::FromFile(reactionsImagesPath["wow"]);
					}
				...
				{
					if (i == 0)
						pictureBox2->BackgroundImage = Image::FromFile(reactionsImagesPath[reaction[i]]);
					else if (i == 1)
						pictureBox3->BackgroundImage = Image::FromFile(reactionsImagesPath[reaction[i]]);
					else if (i == 2)
						pictureBox4->BackgroundImage = Image::FromFile(reactionsImagesPath[reaction[i]]);
				}
			}
		...
		InitializeComponent();
			...
			Post(int p_id, UserPost^ post)
			{
				...
				if (FacebookSys::AllAccounts[poster_mail]->GetAccountGender()=="Female")
					pictureBox1->BackgroundImage = Image::FromFile(L"C:\\Users\\Eng Mahmoud\\Documents\\Visual Studio 2015\\Projects\\Facebook System\\Facbook Matrial\\UserFemaleIcon.png");
				if (FacebookSys::AllAccounts[FacebookSys::user_email]->GetAccountGender()=="Female")
					pictureBox5->BackgroundImage= Image::FromFile(L"C:\\Users\\Eng Mahmoud\\Documents\\Visual Studio 2015\\Projects\\Facebook System\\Facbook Matrial\\UserFemaleIcon.png");
				ReactionPriority->Add("like");
				reactionsImagesPath->Add("like", likeimage);
				ReactionPriority->Add("love");
				reactionsImagesPath->Add("love", loveimage);
				ReactionPriority->Add("haha");
				reactionsImagesPath->Add("haha", hahaimage);
				ReactionPriority->Add("wow");
				reactionsImagesPath->Add("wow", wowimage);
				ReactionPriority->Add("sad");
				reactionsImagesPath->Add("sad", sadimage);
				ReactionPriority->Add("angry");
				reactionsImagesPath->Add("angry", angryimage);
...
private: System::Void bunifuFlatButton1_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	if (FacebookSys::AllAccounts[poster_mail]->getMypost(post_id)->Getreactors()->GettotalReactors()->ContainsKey(FacebookSys::user_email))
	{
		...
		bunifuFlatButton1->Iconimage = Image::FromFile(noLike_Image);
		bunifuFlatButton1->Text = "Like";

...
namespace FacebookSystem {
	...
	public:
		String^ e_mail;
		String^ hahaimage = L"Facbook Matrial\\Constant Reacts\\hahaC.PNG";
		String^ likeimage = L"Facbook Matrial\\Constant Reacts\\likeC.PNG";
		String^ loveimage = L"Facbook Matrial\\Constant Reacts\\loveC.PNG";
		String^ wowimage = L"Facbook Matrial\\Constant Reacts\\wowC.PNG";
		String^ sadimage = L"Facbook Matrial\\Constant Reacts\\sadC.PNG";
		String^ angryimage = L"Facbook Matrial\\Constant Reacts\\angryC.PNG";
		String^ noLike_Image = L"Facbook Matrial\\Constant Reacts\\Like-512.PNG";
		...
		AccountShow(String^email,String^ ReactType)
		{
			...
			else
			{
				...
				if (ReactType == "love")
					pictureBox2->BackgroundImage = Image::FromFile(loveimage);
				if (ReactType == "haha")
					pictureBox2->BackgroundImage = Image::FromFile(hahaimage);
				if (ReactType == "wow")
					pictureBox2->BackgroundImage = Image::FromFile(wowimage);
				if (ReactType == "angry")
					pictureBox2->BackgroundImage = Image::FromFile(angryimage);
				if (ReactType == "sad")
					pictureBox2->BackgroundImage = Image::FromFile(sadimage);

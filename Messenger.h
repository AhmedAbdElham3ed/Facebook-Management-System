...
namespace FacebookSystem {
	...
	public:
		...
		Messenger(int id)
		{
			...
			String^ mail = FacebookSys::AllAccounts[FacebookSys::user_email]->getmyConversations()[id]->GetUserEmails()[0];
			label2->Text = FacebookSys::AllAccounts[mail]->GetAccountUserName();
		}

...
public:
	...
	static SqlConnection^ Con = gcnew SqlConnection("Data Source=DESKTOP-71JOBPV\\AHMEDABDELHAMED;Initial Catalog=Facebook Management System;Integrated Security=True");
	static void load();
